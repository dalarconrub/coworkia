...
Uso: python tools/validate_case_09.py
    ...
    for ctx in B13_CONTEXTOS:
        ...
        for md in base.rglob("*.md"):
            ...
            if citekey:
                ...
                fichas.append({"path": str(md), "ruta": rel, "citekey": citekey})
    return fichas
...
def main() -> int:
    ...
    match_bib = [f for f in fichas if f["citekey"] in bib_citekeys]
    ...
    huerfanas_bib = [f for f in fichas if f["citekey"] not in bib_citekeys]
    ...
    if huerfanas_bib or faltan_obs or faltan_pp:
        return 1
